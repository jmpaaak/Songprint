    ...
    draw: function(id, d, options, paramArray) {
        ...
        d.forEach(function(y, x){
            ...
            g.selectAll(".area")
                ...
                .style("fill", function () {
                    if (paramArray[0] == "R&B") return nodeColor[0];
                    if (paramArray[0] == "발라드") return nodeColor[1];
                    if (paramArray[0] == "포크") return nodeColor[2];
                    if (paramArray[0] == "댄스") return nodeColor[3];
                    if (paramArray[0] == "락") return nodeColor[4];
                    if (paramArray[0] == "힙합") return nodeColor[5];
                })
